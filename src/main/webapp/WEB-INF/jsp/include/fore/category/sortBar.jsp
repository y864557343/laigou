...
$(function(){
	...
	$("input.sortBarPrice").keyup(function(){
		...
		var begin = $("input.bp").val();
		var end = $("input.ep").val();
...
<div class="categorySortBar">
	...
	<table class="categorySortBarTable">
		<tr>
			<td><input class="sortBarPrice bp" type="text" placeholder="请输入"></td>
			<td class="grayColumn priceMiddleColumn">-</td>
			<td><input class="sortBarPrice ep" type="text" placeholder="请输入"></td>
		</tr>
	</table>
