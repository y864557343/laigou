	...
	$(function(){
		...
		$(".buyForm").submit(function(){
			if($("#address").val().length<=0){
				$("span.errorMessage").html("请输入详细地址");
				$("div.registerErrorMessageDiv").css("visibility","visible");
				return false;
			}
			if($("#post").val().length!=6){
				$("span.errorMessage").html("请重新输入邮编");
				$("div.registerErrorMessageDiv").css("visibility","visible");
				return false;
			}
			if($("#mobile").val().length!=11){
				$("span.errorMessage").html("请输入正确的电话号码");
				$("div.registerErrorMessageDiv").css("visibility","visible");
				return false;
			}
			if(0==$("#receiver").val().length){
				$("span.errorMessage").html("请输入收货人");
				$("div.registerErrorMessageDiv").css("visibility","visible");
				return false;
			}
...
<div class="buyPageDiv">
	<form action="forecreateOrder" method="post" class="buyForm">
		...
		<div class="buyFlow">
			<img class="pull-left" src="img/site/lago.png">
			...
			<div>
				...
				<table class="addressTable">
					<tr>
						...
						<td><textarea name="address" id="address" placeholder="建议您如实填写详细收货地址，例如接到名称，门牌好吗，楼层和房间号等信息"></textarea></td>
					</tr>
					<tr>
						<td>邮政编码</td>
						<td><input  name="post" id="post" placeholder="如果您不清楚邮递区号，请填写000000" type="text"></td>
					</tr>
					<tr>
						<td>收货人姓名<span class="redStar">*</span></td>
						<td><input  name="receiver" id="receiver"  placeholder="长度不超过25个字符" type="text"></td>
					</tr>
					<tr>
						<td>手机号码 <span class="redStar">*</span></td>
						<td><input name="mobile"  id="mobile" placeholder="请输入11位手机号码" type="text" onkeyup="value=value.replace(/[^\d]/g,'')"></td>
					</tr>
				</table>
			...
			<table class="productListTable">
				...
				<tr>
					<th colspan="2" class="productListTableFirstColumn">
						...
						<a class="marketLink" href="#nowhere">店铺：来购店铺</a>
